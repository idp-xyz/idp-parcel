...
| [05](issues/05-cc-duty-reconciliation-hands-off-to-settlement-accounting.md) | UC-CC-009 核对向 SA 的交接（outbox 意图）——**resolved，2026-09-11 15:0x 完工待评审进 main**（分支 `mcp5-sacc05`，代码 tip `353597a2`、分支 tip `27b30cd8` 含清点；分区主体 租户 / 申报范围 带口名段；四条判断项见票 Comments） | CC | 无 |
