...
【裁决已落】2026-08-26 用户经队列通道 1 委托裁断,裁定路径 b(范围收窄为运营查阅
端点、排除 /customer-tracking-view),记录在 [ADR-0078](../../docs/adr/0078-isolated-environment-operations-reads-admit-by-assembly-injection.md);实现票为 issues/05。本文其余部分为取证材料,不改写。
