...
Category: chore
Status: in-progress——材料四件已落（见下），两处范围裁决与一线过渡方案归用户，未裁前本 spec 不关
...
| [decision-brief-scope-and-frontline.md](./decision-brief-scope-and-frontline.md) | 两处范围冲突（尾程面单渠道 vs PAR-COM-12；COD 字段确认）、一线作业过渡方案选项、gk.idp.xyz 待信息、证据文件安全处置建议 | 决策简报，裁决归用户 |
