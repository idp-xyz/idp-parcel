...
Status: ready-for-agent——「要先裁的一格」已由通道 1 代裁（2026-09-09，用户经 IDP 队列授权「你自决，目标是全部解决」），裁决见下「裁决」节；实施者按裁决落 ADR-0128（号由通道 1 给）与三层代码。此前 draft——只读取证（MCP-6，锚 `2efef58e`），PS 地盘归 MCP-2；交 MCP-1 派
