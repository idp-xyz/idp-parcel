...
| [04](./issues/04-object-workspace-template.md) | `DetailPageTemplate` 对齐对象工作区母版：Object Header + Summary Strip + 稳定命名的 Tabs；委托查阅详情页首用 | in-progress（通道 5；第 1–5 条已进 main `3fbf2ec2`，评审 ← 通道 6 两轴 0 阻断；第 6 条演示页阻塞已解，待从 `origin/main` 补一笔） |
