...
| [02](./issues/02-legal-entity-identity-carries-registration.md) | 责任法人身份登记加注册国家 / 地区与终身注册号 | resolved · 分支 `mcp3-lep02`（含清点 tip `4193e0e7`）· 待评审与推送方重放 |
| [03](./issues/03-legal-entity-profile-revisions-and-as-of-resolution.md) | 法人资料修订链与按时点解析（含「资料不全」答复） | resolved · 分支 `mcp3-lep03`（代码 tip `4b9811fe`，含清点）· 待评审与推送方重放 |
