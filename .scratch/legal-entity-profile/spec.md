...
| [05](./issues/05-profile-write-isolated-admission-and-as-of-resolution-read.md) | 服务端：资料登记写口进隔离写准入、法人资料按时点解析读口 | resolved · 分支 `mcp3-lep05`（代码 tip `6be912f3`，含清点 `f23b2e9d`）· 待评审与推送方重放 |
