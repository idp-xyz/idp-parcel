...
12. **历史法人要先补身份层才能补资料**（评审 Spec 非阻断 1 补记）：`RegisterLegalEntityProfileHandler.checkSuccessor` 对最新修订没有身份层的法人（`0034` 之前登记）拒收资料，拒因里写明续办：先登一笔带身份层的法人修订。注册地址的国家 / 地区要对着身份上的注册国家 / 地区判（ADR-0145 决定三），没有身份层就无从判；先收下、等补登后再判也不行——资料修订一经登记不可覆盖，一笔没核过国家的地址会一直留在修订链上。所以决定六「法人可以先登记、后补资料」对历史法人读作：先补身份层，再补资料。
...
### 评审处置 ← 通道 3（作者） · 2026-09-24

- Spec 非阻断 1 → 补为判断项「历史法人要先补身份层才能补资料」。行为不改，不另立票：`checkSuccessor` 的拒因已写明续办。
