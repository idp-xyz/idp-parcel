...
| [16](../../operator-channel/issues/16-stale-par-int-01-comments-on-operator-faces.md) | 过期注释：运营侧接入面的认证不再写「属 `PAR-INT-01` 待提供」（2026-09-25 随 ADR-0151 补立并做完；管理台前端注释记为后续） | 无 |
