...
- 04 已登记未读行的收口裁决（关务六类 + 商业阶段内容声明一族）—— `Status: ready-for-agent`。导航裁决已作出：**一张新页都不开**，七类全部并进既有页；商业那一族按拥有对象拆成两半，其中授权规则要给 `commercial-policies` 加第六个页签。拆四张接线子票，分组与串并行约束见票面。
