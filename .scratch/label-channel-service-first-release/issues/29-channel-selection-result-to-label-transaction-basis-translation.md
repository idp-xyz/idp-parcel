...
- **评审 ← 通道 6 · 钉 `b1d8bc40`（代码 tip `2d19bc32`，基线 `76932b38`，5 笔）· 2026-09-10 20:0x**（task-0509b519，非作者，隔离树 `%TEMP%\idp-review-lc29`；由推送方代落）。评审侧验证（无 DSN——本票不动 postgres）：`gofmt -l ./internal/parcelshipment` 空；`go vet ./internal/parcelshipment/...` 退 0；`go test -count=1` PS domain / application / adapters/partycommercial / adapters/parcelpricing / internal/architecture 五包 ok；未跑全仓。
