...
>
> 2026-09-04 19:3x 通道 1 重放进 main（远端 `19cf2ce5`），**main SHA**：`b3acc4d5`→`ec1033e4`、`dd96456e`→`844b52fc`、
> `2d7de00a`→`a0b1acd7`、`0b34f3b9`→`0f0876d1`；本票转 resolved 那笔 `f3012a06`→`fd2d9958`。分支清点笔 `0be8b4fd` 未重放，
> 由 tip 上的 `19cf2ce5` 一次重生成兑底。分支 `mcp5-lc19-21` 指针保留作封存出处。
