...
| [10](./issues/10-business-party-relationship-deactivation-field-forms.md) | 参与方身份 / 关系 / 身份停用三册逐字段表单（ADR-0101 决定八），JSON 签降为折叠区 | in-progress（通道 6 完工 23:1x，分支 `mcp6-adminweb10@916030c7` 已推；评审派通道 5，无阻断后重放） |
