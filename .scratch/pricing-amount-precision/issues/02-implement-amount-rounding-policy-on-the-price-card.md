...
- 2026-09-04 · MCP-1：**进 main 记录。** 领域半边随换号批重放为 `70dbf5a6`（分支 `717a06e8`，见 22:2x 广播）；余项随 MCP-3 换号批续作重放：`2bef7c9e`→`5ed07e17`（SA-c 适配器 `internal/settlementaccounting/adapters/parcelpricing`，与 shape-gaps/03 的 SA 半边同笔），四票公共笔 `168a134d`→`67921a58`、`ae672499`→`7404f40d`、`f4577408`→`07361d8e`；清点 `732c1db3`。登记表单槽按 ADR-0101 决定八核定不做、E2 未开工——两处理由与待办在票面「完成记录」。验证与远端 main 同 shape-gaps/01 的进 main 记录（`732c1db3`）。
