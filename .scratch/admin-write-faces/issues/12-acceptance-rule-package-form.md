...
Status: blocked——伞票 [07](./07-commercial-publication-operator-main-paths-per-register.md) 拆出（MCP-6 2026-09-07，锚 `95182b9d`）；等公共半边；伞票点名的「先答声明随发布怎么在表单里表达」在本票「选形与理由」答
Blocked by: 08
...
（0013 终局规则）。pc-gaps/09、10（终局规则有效期声明、资料修订允许声明）落地后还会各多一节。
...
下拉，表单不内置。新通道（pc-gaps/09、10）落地时是**加一节**，不改本票的形。

## 硬句

伞票四条逐字适用；另一条本册特有：`manualReview` 那一格答的是「要不要人工复核」（接单规则正文），与
...
不动任何声明表；不改「声明只能随发布」；pc-gaps/09、10 的新节在那两票落地后由它们自己加。
