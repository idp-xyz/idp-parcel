...
**批后追加（2026-08-31，MCP-5，不改本批已收口结论）**：频道指示两页骨架完整实现——票 08
重启认领（机制半边，范围见其 Comments），另开票 09 承接 acceptance-review 接线；批收口时
的「装配四件归 MCP-1 串行」在两票期间由 MCP-5 独占接管（已在频道广播占号）
...
01、02、03、04、05、06、07、08、09——见 `issues/`（09 为批后追加的 acceptance-review 接线票）。
