// 本目录唯一的 fetch 出口:UC-PS-001 提交与 UC-PS-005 决定前撤回两个端点。
//
...
// ---- 请求草案形状 ----
//
// 真实线格式不是本目录能定的:两个端点当前挂「未配置即拒」Intake,不读请求体;
...
async function post<Body>(path: string, payload: unknown): Promise<ApiResult<Body>> {
