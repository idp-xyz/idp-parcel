...
// findAcceptedRequestCoveringParcel 是两条按（租户，包裹）答问的读口（DeliveryPlaceReferenceView、
// CommercialResolutionReferenceView）共用的那一段路：走 `declared_parcel_ids` 上的部分 GIN（迁移 0006，只认已接受）
