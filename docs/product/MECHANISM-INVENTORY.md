...
| **合计** | 1004 | 954 | 124 | 269 | 57 | 134 |

业务上下文 12 个，非业务目录 2 个。`cmd/` 生产 64、测试 91。
...
## 接线面：接入面端点 126 个，消费适配器 33 个生产文件，直投路由表 24 条
