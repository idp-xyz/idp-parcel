...
| parcelshipment | partycommercial | 14 |
...
| party_commercial | 28 |
| pilot_governance | 6 |
| settlement_accounting | 17 |
| transport_fulfillment | 19 |
| visibility_exception | 26 |

## 接线面：接入面端点 107 个，消费适配器 26 个生产文件，直投路由表 17 条
