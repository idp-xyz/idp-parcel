...
| **合计** | 809 | 755 | 109 | 233 | 51 | 103 |

业务上下文 12 个，非业务目录 2 个。`cmd/` 生产 52、测试 74。

## 跨上下文消费缝：19 组，50 个生产文件
...
## 接线面：接入面端点 97 个，消费适配器 26 个生产文件，直投路由表 17 条
