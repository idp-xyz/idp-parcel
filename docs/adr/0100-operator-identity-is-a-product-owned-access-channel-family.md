...
- [ADR-0150](./0150-synthetic-tenant-is-treated-as-a-real-tenant-and-isolated-form-retires-per-face.md)：部分停用本记录决定五第二条中隔离形态与操作者渠道「互不替代、不合并」的一段——合成租户经真渠道进出，隔离形态逐口随真渠道退场
