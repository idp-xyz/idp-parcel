...
var businessEndpointProbes = map[string]businessEndpointProbe{
	...
	"/transport-fulfillment/delivery-attempts":                                 {method: http.MethodPost, target: "/transport-fulfillment/delivery-attempts"},
	...
	"/pricing-estimates":                                                       {method: http.MethodPost, target: "/pricing-estimates"},
	...
	"/commercial-group-legal-entities/{legalEntityId}/profile-resolution":      {method: http.MethodGet, target: "/commercial-group-legal-entities/SYN-LE-01/profile-resolution?at=2026-09-24T00:00:00Z"},
...
func assembleUnwiredBusinessEndpointsWith(
	...
	return assembleBusinessEndpoints(
		...
		unwiredLegalEntityProfileResolver{},
