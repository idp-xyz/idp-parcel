...
func TestEveryAssembledEndpointAnswersUnconfigured(t *testing.T) {
	...
	endpoints := assembleBusinessEndpoints(unwiredSubmission{}, unwiredWithdrawal{}, unwiredRequestViews{}, unwiredCancellation{}, unwiredReception{}, unwiredDelivery{}, unwiredTrackingViews{}, unwiredClaims{}, unwiredResults{})
...
func TestUnconfiguredDoesNotSwallowTheMethodGate(t *testing.T) {
	router := httpapi.NewWithEndpoints(buildinfo.Info{}, assembleBusinessEndpoints(unwiredSubmission{}, unwiredWithdrawal{}, unwiredRequestViews{}, unwiredCancellation{}, unwiredReception{}, unwiredDelivery{}, unwiredTrackingViews{}, unwiredClaims{}, unwiredResults{}))
